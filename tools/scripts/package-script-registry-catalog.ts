...
const RAW_SCRIPT_REGISTRY: Readonly<Record<string, any>> = Object.freeze({
  ...
  "verify:mcp-client-identity-proof": {
    ...
    inputs: ["tools/server-scripts/verify-mcp-client-identity-proof.ts", "packages/foundation/src/security/process-identity/**", "packages/capabilities/src/operation-permission-core/**"], outputs: ["build/reports/mcp-client-identity-proof.json"],
  },
  "verify:mcp-process-identity-credential-store": {
    ...
    inputs: ["tools/server-scripts/verify-mcp-process-identity-credential-store.ts", "packages/protocols/mcp/adapter/gateway-installer/bin/meshrix-mcp.ts", "packages/protocols/mcp/adapter/gateway-installer/lib/**", "packages/protocols/mcp/adapter/native-installer/**"], outputs: ["build/reports/mcp-process-identity-credential-store.json"],
  },
  "verify:mcp-windows-process-identity-credential-store": {
    ...
    owner: "platform-security", tier: "release", sideEffects: "build-output",
    requiresFreshContainer: false, ciProfile: "security", expectedDurationClass: "fast",
    inputs: ["tools/server-scripts/verify-mcp-windows-process-identity-credential-store.ts", "packages/protocols/mcp/adapter/gateway-installer/bin/meshrix-mcp.ts", "packages/protocols/mcp/adapter/gateway-installer/lib/**"], outputs: ["build/reports/mcp-windows-process-identity-credential-store.json"],
  },
