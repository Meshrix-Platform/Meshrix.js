...
} from "../verifiers/registry-release-authority-baseline.mjs";

const repoRoot = path.resolve(fileURLToPath(new URL("../..", import.meta.url)));
const reportPath = path.join(repoRoot, "build", "reports", "release-authority-baseline.json");
...
const releaseReady = findings.length === 0;
const report = {
  schemaVersion: "v0.0.1:release:authority-baseline-report-1",
  verifier: "tools/server-scripts/verify-release-authority-baseline.mjs",
