...
const SPEC_LIST = [
  ...
  defineSpec({ path: "build/reports/downstream-mcp-product-e2e.json", schemaVersion: "v0.0.1:mcp:downstream-product-e2e-report-1", verifier: "tools/server-scripts/verify-downstream-mcp-product-e2e.mjs", timestampField: "finishedAt" }),
  defineSpec({ path: "build/reports/enterprise-audit-retention-redaction.json", schemaVersion: "v0.0.1:observability:audit-retention-redaction-report-1", verifier: "tools/server-scripts/verify-enterprise-audit-retention-redaction.mjs", timestampField: "finishedAt", readyFields: ["summary.readyForReleaseReduction"], provenance: { producer: "licomesh-core-observability", commandId: "enterprise-audit-retention-redaction" }, requiresFinalization: true }),
  ...
  defineSpec({ path: "build/reports/enterprise-observability-coverage.json", schemaVersion: "v0.0.1:observability:enterprise-coverage-report-1", verifier: "tools/server-scripts/verify-enterprise-observability-coverage.mjs", readyFields: ["summary.readyForReleaseReduction"], provenance: { producer: "licomesh-core-observability", commandId: "enterprise-observability-coverage" }, requiresFinalization: true }),
  ...
  defineSpec({ path: "build/reports/job-work-queue-capacity.json", schemaVersion: "v0.0.1:workflow:job-work-queue-capacity-report-1", verifier: "tools/server-scripts/verify-job-work-queue-capacity.mjs", timestampField: "finishedAt", provenance: { producer: "licomesh-core-job-work-queue-capacity", commandId: "job-work-queue-capacity" } }),
  ...
  defineSpec({ path: "build/reports/observability-runtime-acceptance.json", schemaVersion: "v0.0.1:observability:runtime-acceptance-report-1", verifier: "tools/server-scripts/verify-observability-runtime-acceptance.mjs", timestampField: "finishedAt", readyFields: ["summary.readyForReleaseReduction"], provenance: { producer: "licomesh-core-observability", commandId: "observability-runtime" }, requiresFinalization: true }),
  defineSpec({ path: "build/reports/observability-semantics.json", schemaVersion: "v0.0.1:observability:semantics-0.2.0", verifier: "tools/server-scripts/verify-observability-semantics.mjs", readyFields: ["summary.readyForReleaseReduction"], provenance: { producer: "licomesh-core-observability", commandId: "observability-semantics" }, requiresFinalization: true }),
  ...
  defineSpec({ path: "build/reports/plugin-runtime.json", schemaVersion: "v0.0.1:plugin:runtime-verification-report-3", verifier: "tools/server-scripts/verify-plugin-runtime.mjs" }),
  ...
  defineSpec({ path: "build/reports/security-alert-lifecycle.json", schemaVersion: "v0.0.1:security:alert-lifecycle-report-1", verifier: "tools/server-scripts/verify-security-alert-lifecycle.mjs", readyFields: ["summary.readyForReleaseReduction"], provenance: { producer: "licomesh-core-observability", commandId: "security-alert-lifecycle" }, requiresFinalization: true }),
  ...
  defineSpec({ path: "build/reports/upload-workspace-materialization.json", schemaVersion: "v0.0.1:jobs:upload-workspace-materialization-report-1", verifier: "tools/server-scripts/verify-upload-workspace-materialization.mjs", timestampField: "finishedAt", provenance: { producer: "licomesh-core-upload-workspace-materialization", commandId: "upload-workspace-materialization" } }),
...
export function validateRequiredReport(relativePath, input, {
  ...
  if (spec.requiresFinalization) {
    ...
    if (
      privacy.finalizer !== "licomesh-core-observability" ||
