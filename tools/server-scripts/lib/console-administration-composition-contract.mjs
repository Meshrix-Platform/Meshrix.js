export const CONSOLE_COMPOSITION_SOURCE_PATH = "apps/console/composables/useConsole.ts";

export const CONSOLE_COMPOSITION_REQUIRED_TOKENS = Object.freeze([
...
export const CONSOLE_COMPOSITION_FORBIDDEN_PATTERNS = Object.freeze([
