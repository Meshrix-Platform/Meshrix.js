...
export const RELEASE_JOURNEY_FIXTURE_FILENAME = "chinese-input.txt";
export const RELEASE_JOURNEY_FIXTURE_SHA256 = "36c5d00309034a0b59d83efd8698c5366b8e7a6674ae80cfcbe31171ee0583a8";
export const RELEASE_JOURNEY_FIXTURE_BYTES = Buffer.from(
...
export const RELEASE_JOURNEY_FIXTURE_TEXT = RELEASE_JOURNEY_FIXTURE_BYTES.toString("utf8");
