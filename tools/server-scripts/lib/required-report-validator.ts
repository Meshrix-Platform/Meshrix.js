...
export const REQUIRED_REPORT_REDUCERS: Readonly<Record<string, any>> = Object.freeze({
  ...
  MCP_PROCESS_IDENTITY_CREDENTIAL_STORE: "tools/server-scripts/lib/mcp-process-identity-credential-store-evidence.ts#createMcpProcessIdentityCredentialStoreReadiness",
...
const SPEC_LIST: any[] = [
  ...
  defineSpec({ path: "build/reports/job-work-queue-capacity.json", schemaVersion: "v0.0.1:workflow:job-work-queue-capacity-report-1", verifier: "tools/server-scripts/verify-job-work-queue-capacity.ts", timestampField: "finishedAt", readyFields: ["summary.verificationPassed"], provenance: { producer: "meshrix-core-job-work-queue-capacity", commandId: "job-work-queue-capacity" } }),
  ...
  defineSpec({ path: "build/reports/mcp-client-identity-proof.json", schemaVersion: "v0.0.1:process-identity:mcp-client-proof-report-1", verifier: "tools/server-scripts/verify-mcp-client-identity-proof.ts" }),
  defineSpec({ path: "build/reports/mcp-authorization-request-filters.json", schemaVersion: "v0.0.1:mcp:authorization-request-filters-report-1", verifier: "tools/server-scripts/verify-mcp-authorization-request-filters.ts", timestampField: "finishedAt" }),
  ...
  defineSpec({ path: "build/reports/mcp-process-identity-credential-store.json", schemaVersion: "v0.0.1:process-identity:mcp-credential-store-report-0.0.3", verifier: "tools/server-scripts/verify-mcp-process-identity-credential-store.ts", reducer: REQUIRED_REPORT_REDUCERS.MCP_PROCESS_IDENTITY_CREDENTIAL_STORE }),
  ...
  defineSpec({ path: "build/reports/observability-runtime-acceptance.json", schemaVersion: "v0.0.1:observability:runtime-acceptance-report-1", verifier: "tools/server-scripts/verify-observability-runtime-acceptance.ts", timestampField: "finishedAt", readyFields: ["summary.readyForReleaseReduction"], provenance: { producer: "meshrix-core-observability", commandId: "observability-runtime" }, requiresFinalization: true }),
  ...
  defineSpec({ path: "build/reports/controlled-execution-convergence-final.json", schemaVersion: "v0.0.1:execution-sandbox:controlled-execution-convergence-final-report-1", verifier: "tools/server-scripts/verify-controlled-execution-convergence.ts", readyFields: ["summary.controlledExecutionConvergenceReady"] }),
  ...
  defineSpec({ path: "build/reports/private-deployment-open-platform-e2e.json", schemaVersion: "v0.0.1:deployment:private-open-platform-e2e-report-1", verifier: "tools/server-scripts/verify-private-deployment-open-platform-e2e.ts", timestampField: "finishedAt" }),
