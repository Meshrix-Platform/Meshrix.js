...
import { createStorageProductionRestoreReadiness } from "./lib/storage-production-restore-evidence.mjs";
...
async function main() {
  ...
  const restoreReadiness = createStorageProductionRestoreReadiness(drillReport);
