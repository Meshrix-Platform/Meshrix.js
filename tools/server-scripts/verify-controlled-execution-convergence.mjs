...
import { finalValidationBindingForProfile } from "../plan/plan-dependency-map.mjs";
...
const PLAN_DIRECTORY = "end-to-end-release/enterprise-single-node";
...
export async function verifyControlledExecutionConvergence({ repoRoot = REPO_ROOT, writeReport = true } = {}) {
  ...
  const finalBinding = finalValidationBindingForProfile(mapPlan, "local");
