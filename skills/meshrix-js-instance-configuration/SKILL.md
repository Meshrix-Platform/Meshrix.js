...
| Publish any upstream service (HTTP, JSON-RPC, MCP, or host stdio command) into Meshrix.js | Read [agent-connectivity.md](references/agent-connectivity.md), then apply `$meshrix-js-upstream-service-publishing` |
