...
describe("MCP catalog delivery wire contract", () => {
  it("accepts the frozen positive corpus and emits the canonical invalidation", () => {
  ...
  it("rejects identity-bearing, catalog-bearing, malformed, and extended wire values", () => {
