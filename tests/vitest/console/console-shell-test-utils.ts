...
const CONSOLE_SHELL_NAMESPACE_MEMBERS = {
  ...
  refresh: ["pageRefreshAriaLabel", "pageRefreshBusy", "pageRefreshTitle", "refreshAuthAdmin", "refreshAuthState", "refreshBackgroundProcesses", "refreshCurrentPage", "refreshDashboardAlertsSnapshot", "refreshMonitorAlerts", "refreshOperationPermission", "refreshState"],
  ...
  modules: ["disableMountModule", "enableMountModule", "enabledMountCount", "isMountPathEditing", "moduleGroups", "mountDraft", "openMountPathPicker", "reloadModules", "saveMountModules", "toggleMountPathEdit", "totalMountCount"],
  ...
  settings: ["highlightedConfigTarget", "saveSettings", "settingsDraft"],
