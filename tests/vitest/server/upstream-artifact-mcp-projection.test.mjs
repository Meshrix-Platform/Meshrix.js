...
describe("upstream artifact MCP projection", () => {
  ...
  it("passes workspace references through as opaque arguments", async () => {
    const executeTool = vi.fn(async () => ({
      ok: true,
      status: 200,
    ...
    const workspaceReference = "workspace:workspace_0123456789abcdef01234567:notes/source.txt";
