...
const lifecycleModuleUrl: any = new URL(
  "../../../packages/foundation/src/storage/storage-lifecycle-lock.ts",
  import.meta.url
).href;

const resolverFailureProbe: any = String.raw`
...
describe("storage lifecycle lock", () : any => {
  it("uses the Node process time origin for current ownership and fails closed for unverifiable foreign ownership", () : any => {
