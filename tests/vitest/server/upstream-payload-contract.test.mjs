...
} from "../../../packages/agents/src/upstream-gateway/payload-contract.mjs";

describe("upstream payload representation contract", () => {
  it("requires explicit bounded request and response representations", () => {
    expect(() => compilePayloadTransport({})).toThrow("request representation mode is required");
  ...
  it("rejects unsafe multipart mappings and strips authority or credential headers", () => {
    expect(() => compilePayloadTransport({
      payloadTransport: {
        request: {
    ...
    const selected = selectRequestRepresentationHeaders({
