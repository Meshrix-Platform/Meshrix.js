...
export declare const MCP_CATALOG_ACKNOWLEDGE_METHOD: "lico/catalog/acknowledge";
export declare const MCP_PROXY_SESSION_HEADER: "X-LicoMesh-Mcp-Proxy-Session";
