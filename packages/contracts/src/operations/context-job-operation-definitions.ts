...
export const CONTEXT_JOB_OPERATION_DEFINITIONS: readonly any[] = Object.freeze([
{
      id: "context.preview",
    ...
    },
{
      ...
      externalAuthVerifier: {
        controller: "system",
        method: "verifyConsoleOrToolSkillExternalAuth",
        requiredScopes: ["uploads:write"],
        recordUse: true
      }
    },
    ...
    },
{
      ...
      inputSchema: {
        ...
        properties: {
          ...
          forceNewVersion: { type: "boolean" },
          inputText: { type: "string", minLength: 1, maxLength: 1048576 },
          parentJobId: { type: "string", minLength: 1, maxLength: 256 },
          settings: { type: "object" },
          uploadSessionId: { type: "string", minLength: 1, maxLength: 256 },
          versionGroupId: { type: "string", minLength: 1, maxLength: 256 },
          workspaceId: { type: "string", minLength: 1, maxLength: 256 }
        },
        oneOf: [
          {
            required: ["uploadSessionId"],
            not: { required: ["inputText"] }
          },
          {
            required: ["inputText"],
            not: { required: ["uploadSessionId"] }
          }
        ]
      },
    ...
    },
{
      ...
      inputSchema: {
        ...
        properties: {
          uploadSessionId: { type: "string", minLength: 1, maxLength: 256 },
          workspaceId: { type: "string", minLength: 1, maxLength: 256 },
          expectedWorkspaceRevision: { type: "string", minLength: 1, maxLength: 256 },
          logicalTarget: { type: "string", minLength: 1, maxLength: 1024 }
        }
      },
