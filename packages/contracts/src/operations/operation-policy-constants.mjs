...
export const OPERATION_PROOF_PROFILES = Object.freeze({
  FULL: "full",
  RECEIPT: "receipt",
  ON_CHANGE: "on-change",
  EXCLUDED: "excluded"
...
export const DEFAULT_REPAIR_APPROVAL_SCOPE = "maintenance:approve";

export const READ_ONLY_POST_OPERATION_IDS = new Set([
  "auth.roles.get",
  "context.compaction.preview",
  "settings.model_probe"
]);

export const PUBLIC_OPERATION_IDS = new Set([
  "system.health",
  "system.bootstrap",
  "auth.session",
  "auth.login",
...
export const PROOF_EXCLUDED_OPERATION_IDS = new Map([
...
export const EXTERNAL_AUTH_OPERATION_IDS = new Set([
  "agent_sync.publish",
...
export const EXTERNAL_AUTH_MISSING_CODE_DECORATORS = new Map([
...
export const EXTERNAL_AUTH_VERIFIER_DECORATORS = new Map([
...
export const REQUIRED_SCOPE_DECORATORS = new Map([
...
export const SAFETY_DECORATORS = new Map([
...
export const CONCURRENCY_GROUP_DECORATORS = new Map([
