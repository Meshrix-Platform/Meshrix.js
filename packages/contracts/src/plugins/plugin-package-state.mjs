...
export function isPluginPackageState(value) {
  return typeof value === "string" && PLUGIN_PACKAGE_STATE_SET.has(value);
}

export function assertPluginPackageTransition(from, to, event = "transition") {
...
export function listPluginPackageTransitions(from) {
