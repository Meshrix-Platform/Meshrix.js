...
export const ARCHITECTURE_MODULE_CATEGORY_BY_LAYER = Object.freeze({
...
export const DOCUMENTATION_ASSET_CLASSIFICATIONS = Object.freeze([
  ...
  Object.freeze({
    ...
    classification: "developer-documentation",
    paths: Object.freeze(["packages/contracts/src/modules/manifest.mjs"]),
  ...
  Object.freeze({
    ...
    classification: "developer-documentation",
    paths: Object.freeze(["packages/foundation/src/observability/architecture-live-map.mjs"]),
