...
`tool-skill-management-provider.ts` is the Operation Permission provider boundary. MCP adapters and console workflows must use the provider boundary instead of directly touching registry, store, runtime, or router internals.
