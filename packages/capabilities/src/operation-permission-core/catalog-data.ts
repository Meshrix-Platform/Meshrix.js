...
export const TOOL_ID_BY_OPERATION_ID: Readonly<Record<string, any>> = Object.freeze({
  ...
  "agent_gateway.call": "meshrix.agentGateway.call",
  "model_routing.health": "meshrix.agentGateway.modelRouting.health",
  "agents.list": "meshrix.agentManagement.agents.list",
  "agents.create": "meshrix.agentManagement.agents.create",
  "agents.update": "meshrix.agentManagement.agents.update",
  "agents.delete": "meshrix.agentManagement.agents.delete",
  "maintenance_agent.config.get": "meshrix.maintenanceAgent.config.get",
  "maintenance_agent.config.set": "meshrix.maintenanceAgent.config.set",
  "maintenance_agent.chat": "meshrix.maintenanceAgent.chat",
  "maintenance_agent.runs.create": "meshrix.maintenanceAgent.runs.create",
  "maintenance_agent.runs.list": "meshrix.maintenanceAgent.runs.list",
  "maintenance_agent.runs.get": "meshrix.maintenanceAgent.runs.get",
  "maintenance_agent.runs.approve": "meshrix.maintenanceAgent.runs.approve",
  "maintenance_agent.runs.cancel": "meshrix.maintenanceAgent.runs.cancel",
  ...
  "operation_permission.mcp.request_authorization": "meshrix.operationPermission.mcp.requestAuthorization",
  "operation_permission.mcp.list_requests": "meshrix.operationPermission.mcp.listRequests",
  "operation_permission.mcp.resolve_request": "meshrix.operationPermission.mcp.resolveRequest",
