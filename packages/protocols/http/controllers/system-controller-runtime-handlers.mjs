export function createSystemControllerRuntimeHandlers({
  ...
  return {
    ...
    async handleStorageReconcile({ operation, input, response }) {
      await sendConsoleDomainOperation({
    ...
    async handleStorageBackupCreate({ operation, input, response, operationLock, signal }) {
      await sendConsoleDomainOperation({
    ...
    async handleStorageBackupRetention({ operation, input, response, operationLock, signal }) {
      await sendConsoleDomainOperation({
    ...
    async handleStorageBackupRestorePreview({ operation, input, response, operationLock, signal }) {
      await sendConsoleDomainOperation({
    ...
    async handleStorageBackupRestore({ operation, input, response, operationLock, signal }) {
      await sendConsoleDomainOperation({
    ...
    async handleReadinessBaselineStatus({ operation, response }) {
      await sendConsoleDomainOperation({
    ...
    async handleRequestClientAlignmentCommand({ operation, clientId, requestBody, response, authSession }) {
      await sendConsoleDomainOperation({
    ...
    async handleBuildRuntimeAssembly({ operation, request, requestBody, response }) {
      await sendConsoleDomainOperation({
    ...
    async handleGetExternalGateway({ operation, response }) {
      await sendConsoleDomainOperation({
    ...
    async handleValidateExternalGateway({ operation, requestBody, response }) {
      await sendConsoleDomainOperation({
    ...
    async handleApplyExternalGateway({ operation, requestBody, response }) {
      await sendConsoleDomainOperation({
    ...
    async handleSwitchExternalGatewayDirect({ operation, requestBody, response }) {
      await sendConsoleDomainOperation({
