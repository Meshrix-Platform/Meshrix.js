export function createSystemControllerAuthHandlers({
  ...
  return {
    async handleAuthSession({ operation, request, response }: Record<string, any>) : Promise<any> {
    ...
    async handleAuthLogin({ operation, request, requestBody, response }: Record<string, any>) : Promise<any> {
      await sendConsoleDomainOperation({
    ...
    async handleAuthLogout({ operation, request, authSession, response }: Record<string, any>) : Promise<any> {
      await sendConsoleDomainOperation({
    ...
    async handleAuthUsers({ operation, requestBody, response }: Record<string, any>) : Promise<any> {
      await sendConsoleDomainOperation({
    ...
    async handleAuthUpdateUser({ operation, userId, requestBody, authSession, response }: Record<string, any>) : Promise<any> {
      await sendConsoleDomainOperation({
    ...
    async handleAuthRole({ operation, roleId, response }: Record<string, any>) : Promise<any> {
      await sendConsoleDomainOperation({
    ...
    async handleAuthOidc({ operation, requestBody, authSession, response }: Record<string, any>) : Promise<any> {
      await sendConsoleDomainOperation({
    ...
    async handleAuthAudit({ operation, url, response }: Record<string, any>) : Promise<any> {
      await sendConsoleDomainOperation({
    ...
    async handleAuthAuditExport({ operation, url, response, authSession }: Record<string, any>) : Promise<any> {
      await sendConsoleDomainOperation({
    ...
    async handleAuthAuditRetention({ operation, requestBody, response, authSession }: Record<string, any>) : Promise<any> {
      await sendConsoleDomainOperation({
    ...
    async handleAuthAuditPrune({ operation, requestBody, response, authSession }: Record<string, any>) : Promise<any> {
      await sendConsoleDomainOperation({
    ...
    async handleObservabilityTraceGet({ operation, traceId, url, response }: Record<string, any>) : Promise<any> {
      await sendConsoleDomainOperation({
    ...
    async handleAuthSessions({ operation, response }: Record<string, any>) : Promise<any> {
      await sendConsoleDomainOperation({
    ...
    async handleAuthRotateSession({ operation, request, authSession, response }: Record<string, any>) : Promise<any> {
      await sendConsoleDomainOperation({
    ...
    async handleAuthRevokeSession({ operation, sessionId, authSession, response }: Record<string, any>) : Promise<any> {
      await sendConsoleDomainOperation({
