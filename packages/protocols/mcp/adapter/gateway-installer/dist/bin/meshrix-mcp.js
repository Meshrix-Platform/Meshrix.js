 ...
 */
import { MCP_INTERFACE_VERSION, MCP_STABLE_TOOL_NAME, packageJson } from "../lib/cli/constants.js";
import { parseArgs, usage } from "../lib/cli/basic-utils.js";
import { MESHRIX_MCP_COMMAND_REGISTRY } from "../lib/cli/commands.js";
import { emitCommandError, emitResult } from "../lib/cli/formatters.js";
export async function main(argv = process.argv.slice(2)) {
    ...
    const handler = MESHRIX_MCP_COMMAND_REGISTRY[command];
    if (!handler) {
...
main().catch((error) => {
    ...
    const command = Object.hasOwn(MESHRIX_MCP_COMMAND_REGISTRY, requestedCommand) || ["help", "version"].includes(requestedCommand)
        ? requestedCommand
        : "";
    const options = {
...
//# sourceMappingURL=meshrix-mcp.js.map