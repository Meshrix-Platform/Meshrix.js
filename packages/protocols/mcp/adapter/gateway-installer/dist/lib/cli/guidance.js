import { BOOTSTRAP_INSTALL_SCRIPT_ZH_CN, DEFAULT_TOKEN_ENV, PRIORITY_INSTALL_TARGET, PRIORITY_INSTALL_TARGETS, SUPPORTED_TARGETS, supportedTargetDetails } from "./constants.js";
import { normalizeBaseUrl, option } from "./basic-utils.js";
import { explicitBaseUrl } from "./discovery.js";
import { githubOneLineMcpInstallCommand, shellQuote } from "./connector-process.js";
export function shellCommandForInstall({ target = "codex", includeUrl = false, baseUrl = "http://127.0.0.1:7228", includeToken = false, tokenEnv = "" } = {}) {
...
export function shellCommandForDoctor({ includeToken = false, includeUrl = false, baseUrl = "", tokenEnv = DEFAULT_TOKEN_ENV } = {}) {
