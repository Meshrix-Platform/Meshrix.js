import { MCP_SERVER_NAME, packageJson } from "./constants.js";
import { option, parseTargets, targetInstallMode } from "./basic-utils.js";
import { clientAdapterConnectorRequest, runClientAdapter } from "./client-adapter-runner.js";
import { writeDeviceUninstall } from "./device-config.js";
import { explicitBaseUrl, registryBaseUrls } from "./discovery.js";
import { discoveryRegistryPath, readJson } from "./device-discovery-registry.js";
import { redactSensitiveText, sensitiveOptionValues } from "./installer-output-safety.js";
import { chooseUninstallCandidates, finalizeRevokedLocalMcpCredential, notifyLocalMcpUninstall, } from "./interactive.js";
import { canUseUninstallTui, installerOptions } from "./installer-options.js";
