...
import { CLIENT_FINGERPRINT_VERSION, PROCESS_IDENTITY_CANONICAL_REQUEST_VERSION } from "./constants.js";
import { normalizeTarget } from "./basic-utils.js";
...
export function processIdentityHeaders({ method = "POST", url, body = "", identity = null } = {}) {
    ...
    const signature = sign(null, Buffer.from(canonical, "utf8"), createPrivateKey(identity.privateKeyPem)).toString("base64url");
    return {
...
//# sourceMappingURL=process-identity-request.js.map