...
import { DEFAULT_DISCOVERY_REGISTRY, MESHRIX_MCP_DISCOVERY_FILE_ENV, MESHRIX_MCP_DISCOVERY_URL_ENV, MESHRIX_MCP_URL_ENV } from "./constants.js";
import { option } from "./basic-utils.js";
import { expandHomePath } from "./connector-process.js";
export function discoveryRegistryPath(options = {}) {
    const selected = option(options, "discovery-file", process.env[MESHRIX_MCP_DISCOVERY_FILE_ENV] || DEFAULT_DISCOVERY_REGISTRY);
...
//# sourceMappingURL=device-discovery-registry.js.map