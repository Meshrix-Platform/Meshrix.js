...
export const MCP_PRIORITY_INSTALL_TARGETS = Object.freeze(MCP_CLIENT_TARGETS.filter((item) => item.priority === true).map((item) => item.target));
export const MCP_PRIORITY_INSTALL_TARGET = MCP_PRIORITY_INSTALL_TARGETS.join(",");
export const MCP_TARGET_LABELS = Object.freeze(Object.fromEntries(MCP_CLIENT_TARGETS.map((item) => [item.target, item.label])));
export const MCP_TARGET_INSTALL_MODES = Object.freeze(Object.fromEntries(MCP_CLIENT_TARGETS.map((item) => [item.target, "external-client-adapter"])));
export const MCP_TARGET_LOCATIONS = Object.freeze(Object.fromEntries(MCP_CLIENT_TARGETS.map((item) => [item.target, item.locations])));
...
//# sourceMappingURL=mcp-release-targets.js.map