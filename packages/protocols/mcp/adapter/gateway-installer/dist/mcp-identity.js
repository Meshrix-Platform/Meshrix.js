...
export function buildMcpHandshakePayload({ nonce, issuedAt, identity, discovery, baseUrl, vmBaseUrl, externalGateway = null }) {
    return {
...
export function verifyMcpHandshakeSignature({ publicKeyJwk, payload, signature }) {
    ...
    return verify(null, Buffer.from(stableStringify(payload)), publicKey, Buffer.from(String(signature || ""), "base64url"));
}
//# sourceMappingURL=mcp-identity.js.map