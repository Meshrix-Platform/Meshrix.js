...
The server runtime package is LicoMesh's composition root for state stores, jobs, workers, settings, discovery, server-side console operation projection, and product API orchestration.
