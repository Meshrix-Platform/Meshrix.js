export const INTERACTIVE_INTERFACE_MANIFEST: Readonly<Record<string, any>> = Object.freeze({
  ...
  productApi: Object.freeze({
    ...
    interfaces: Object.freeze([
      ...
      Object.freeze({ name: "buildBootstrapPayload", source: "./discovery-config.ts" }),
      Object.freeze({ name: "createCorePlatformProvider", source: "./core-platform-register.ts" }),
      Object.freeze({ name: "getDiscoveryConfigPath", source: "./discovery-config.ts" }),
      Object.freeze({ name: "loadDiscoveryConfig", source: "./discovery-config.ts" }),
      Object.freeze({ name: "resolveDiscoveryState", source: "./discovery-config.ts" }),
      Object.freeze({ name: "saveDiscoveryConfig", source: "./discovery-config.ts" }),
      Object.freeze({ name: "createTraceContext", source: "../../foundation/src/observability/trace-context.ts" }),
      Object.freeze({ name: "setTraceContextOnRequest", source: "../../foundation/src/observability/trace-context.ts" }),
      Object.freeze({ name: "traceContextFromRequest", source: "../../foundation/src/observability/trace-context.ts" }),
      Object.freeze({ name: "traceDetails", source: "../../foundation/src/observability/trace-context.ts" }),

      // Runtime and storage
      Object.freeze({ name: "createServerRuntime", source: "../module-runtime/server-runtime.ts" }),
      Object.freeze({ name: "createClientRegistryService", source: "../state/client-registry-service.ts" }),
      Object.freeze({ name: "resolveStoredObjectPath", source: "../../../foundation/src/storage/object-store.ts" }),
      ...
      Object.freeze({ name: "composeUnifiedSystemStatus", source: "../devops/unified-registration-core/unified-registration.ts" }),
      Object.freeze({ name: "normalizeUnifiedRegistration", source: "../devops/unified-registration-core/unified-registration.ts" }),
      Object.freeze({ name: "unifiedRegistrationForQueue", source: "../devops/unified-registration-core/unified-registration.ts" }),
      Object.freeze({ name: "unifiedRegistrationForTask", source: "../devops/unified-registration-core/unified-registration.ts" }),
  ...
  platformRegistry: Object.freeze({
    ...
    interfaces: Object.freeze([
      Object.freeze({ id: "security.auth.console", platform: "security", source: "../security/register.ts" }),
      Object.freeze({ id: "security.audit.operations", platform: "security", source: "../security/register.ts" }),
      Object.freeze({ id: "core.provider", platform: "core", source: "../platform-core/register.ts" }),
      Object.freeze({ id: "core.events.protocol", platform: "core", source: "../platform-core/register.ts" }),
      Object.freeze({ id: "core.logging.runtime", platform: "core", source: "../platform-core/register.ts" }),
      Object.freeze({ id: "core.features.runtime", platform: "core", source: "../platform-core/register.ts" }),
      Object.freeze({ id: "core.execution.sandbox", platform: "core", source: "../execution-sandbox/index.ts" }),
      Object.freeze({ id: "core.operations.lockManager", platform: "core", source: "./core-platform-register.ts" }),
      Object.freeze({ id: "core.operations.registry", platform: "core", source: "../platform-core/register.ts" }),
      ...
      Object.freeze({ id: "storage.provider", platform: "storage", source: "../storage/register.ts" }),
      Object.freeze({ id: "storage.kernel", platform: "storage", source: "../storage/register.ts" }),
      Object.freeze({ id: "module-management.provider", platform: "module-management", source: "../module-manager/register.ts" }),
      Object.freeze({ id: "module-management.serverRuntime", platform: "module-management", source: "../module-manager/register.ts" }),
      Object.freeze({ id: "module-management.architectureComponents", platform: "module-management", source: "../module-manager/register.ts" }),
      Object.freeze({ id: "module-management.baseComponents", platform: "module-management", source: "../module-manager/register.ts" }),
      Object.freeze({ id: "module-management.nonHydratableBaseComponents", platform: "module-management", source: "../module-manager/register.ts" }),
      Object.freeze({ id: "module-management.hydratableBaseComponents", platform: "module-management", source: "../module-manager/register.ts" }),
      Object.freeze({ id: "module-management.hydratableComponents", platform: "module-management", source: "../module-manager/register.ts" }),
      Object.freeze({ id: "module-management.mounts", platform: "module-management", source: "../module-manager/register.ts" }),
      Object.freeze({ id: "devops.processStatus.get", platform: "devops", source: "../devops/register.ts" }),
      Object.freeze({ id: "devops.provider", platform: "devops", source: "../devops/register.ts" }),
      Object.freeze({ id: "devops.monitorAlerts.state", platform: "devops", source: "../devops/register.ts" }),
      Object.freeze({ id: "devops.monitorAlerts.saveConfig", platform: "devops", source: "../devops/register.ts" }),
      Object.freeze({ id: "devops.monitorAlerts.runCycle", platform: "devops", source: "../devops/register.ts" }),
      Object.freeze({ id: "devops.monitorAlerts.acknowledge", platform: "devops", source: "../devops/register.ts" }),
      Object.freeze({ id: "devops.unifiedRegistration.normalize", platform: "devops", source: "../devops/register.ts" }),
      Object.freeze({ id: "devops.unifiedRegistration.composeStatus", platform: "devops", source: "../devops/register.ts" })
    ])
  })
});

export function listInteractiveProductApiInterfaces() : any {
  return INTERACTIVE_INTERFACE_MANIFEST.productApi.interfaces.map((entry?: any) : any => entry.name);
}

export function listInteractivePlatformRegistryInterfaces() : any {
  return INTERACTIVE_INTERFACE_MANIFEST.platformRegistry.interfaces.map((entry?: any) : any => entry.id);
}
