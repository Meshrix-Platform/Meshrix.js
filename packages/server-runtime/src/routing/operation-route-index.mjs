...
import { RadixPathTrie } from "./radix-path-trie.mjs";
...
export class OperationRouteIndex {
  ...
  #capabilityByOperationId = new Map();
  ...
  constructor(operations = [], options = {}) {
    ...
    this.#httpRoutes = Object.freeze(this.#httpRoutes.map((route) => Object.freeze(route)));
  }
   ...
   * @returns {object | undefined}
   */
  getCapabilityForOperation(operationId) {
  ...
  _indexHttpOperation(opId, operation) {
  ...
  _indexRpcOperation(opId, operation) {
 ...
 */
export function createOperationRouteIndex(operations, options = {}) {
  return new OperationRouteIndex(operations, options);
}

function _pathnameFrom(path) {
