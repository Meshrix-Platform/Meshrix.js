import { VALID_TRANSITION_RESULTS } from "../engine/state-machine-result-types.mjs";

const ACCEPTANCE_PROOF_CONTRACTS = Object.freeze({
...
function requireExactString(record, key, expected = null) {
...
function checkCapabilityAcceptanceDefinition(def) {
  ...
  requireExactString(acceptance, "verifier", "tools/server-scripts/verify-capability-acceptance-machines.mjs");
