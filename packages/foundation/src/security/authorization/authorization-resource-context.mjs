import { firstString, objectOrNull, stringsFrom, uniqueStrings } from "./authorization-engine-common.mjs";
...
function fieldMapAliases(key, ...resources) {
  const values = [];
...
export function resolveResourceContext({ operation = {}, tool = null, input = {}, context = {} } = {}) {
  const inputResource = {
  ...
  const mapped = (key) => mappedResourceValues({
    key,
    input,
    context,
    inputResource,
