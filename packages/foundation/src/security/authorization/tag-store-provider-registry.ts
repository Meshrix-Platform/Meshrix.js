 ...
 *
 * ```js
 * import { getTagStoreProvider } from "./tag-store-provider-registry.ts";
 ...
 * (e.g., `register-security-providers.ts`) to wire the runtime adapter
 * into the singleton registry.
 *
 * @param {import("./tag-store.port.ts").TagStoreProvider} provider
