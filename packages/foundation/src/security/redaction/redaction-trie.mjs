...
import { canonicalHash } from "../../serialization/canonical-json.mjs";
...
export class RedactionTrie {
   ...
   */
  redact(value, pathPrefix = "", depth = 0) {
   ...
   */
  createRedactedAuditRecord(input, options = {}) {
 ...
 */
export function createDefaultRedactionTrie() {
...
function _compileWildcard(pattern) {
