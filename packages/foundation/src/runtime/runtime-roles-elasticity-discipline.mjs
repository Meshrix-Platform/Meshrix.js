...
export function assertRuntimeRolesElasticityCapabilities(capabilities) {
...
export function assertRuntimeRolesElasticityBoundaries({ control, data, workerRuntime } = {}) {
