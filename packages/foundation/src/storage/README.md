...
LicoMesh Pactium runtimes close storage only when they created it. Closure is
...
Every persistent LicoMesh Pactium runtime also holds the shared storage-runtime
