...
This guide walks through the two runtime plugins selected for this demo in
...
This focused gate validates, builds, packages, and smoke-tests the
repository-local runtime plugins; this demo selects Shared Space and Skill Hub.
Run the full `npm run verify` gate once before committing a candidate.
...
4. Run Core verification commands separately; plugin repository success does
