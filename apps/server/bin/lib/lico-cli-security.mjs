...
import { readJsonInput, readStdinText, trimOneTrailingNewline, writeResponse } from "./lico-cli-common.mjs";

const DEFAULT_CAPABILITY_KERNEL_ALIAS = "lico-tool-grants";
const DEFAULT_CAPABILITY_BINDING_GUARD_ALIAS = "lico-tool-bindings";
...
function capabilityKernelOptions(args = {}) {
  return {
    ...
    backend: args.backend || process.env.LICO_TOOL_GRANT_CAPABILITY_KEY_PROVIDER || process.env.LICO_OPAQUE_CAPABILITY_KEY_PROVIDER || "auto",
    alias: args.alias || process.env.LICO_TOOL_GRANT_CAPABILITY_KEY_ALIAS || DEFAULT_CAPABILITY_KERNEL_ALIAS
  };
}
