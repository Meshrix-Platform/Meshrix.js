...
export const componentFeatureRegistry: readonly ComponentTierDeclaration[] = Object.freeze([
  ...
  { path: "apps/console/components/admin/agent-config/AgentConfigInvocationToggle.vue", feature: "agent-config" },
  { path: "apps/console/components/admin/agent-config/AgentInvocationSettingsPanel.vue", feature: "agent-config" },
  { path: "apps/console/components/admin/agent-config/AgentModelAccessPanel.vue", feature: "agent-config" },
  { path: "apps/console/components/admin/agent-config/AgentModelBindingsPanel.vue", feature: "agent-config" },
  { path: "apps/console/components/admin/agent-config/AgentModelEntryCard.vue", feature: "agent-config" },
  { path: "apps/console/components/admin/agent-config/AgentModelEntryHeader.vue", feature: "agent-config" },
  { path: "apps/console/components/admin/agent-config/AgentModelEntrySummaryActions.vue", feature: "agent-config" },
  { path: "apps/console/components/admin/agent-config/AgentModelLibraryPanel.vue", feature: "agent-config" },
  { path: "apps/console/components/admin/agent-config/AgentModelPromptPanel.vue", feature: "agent-config" },
  { path: "apps/console/components/admin/agent-config/AgentModelProviderFields.vue", feature: "agent-config" },
  ...
  { path: "apps/console/components/admin/maintenance-agent/MaintenanceAgentActionGrid.vue", feature: "maintenance-agent" },
  { path: "apps/console/components/admin/maintenance-agent/MaintenanceAgentPolicyPanel.vue", feature: "maintenance-agent" },
  { path: "apps/console/components/admin/maintenance-agent/MaintenanceAgentRunDetail.vue", feature: "maintenance-agent" },
  { path: "apps/console/components/admin/maintenance-agent/MaintenanceAgentRunList.vue", feature: "maintenance-agent" },
  { path: "apps/console/components/admin/maintenance-agent/MaintenanceAgentSummaryCard.vue", feature: "maintenance-agent" },
  ...
  { path: "apps/console/components/shell/side-nav/ConsoleSideNavModelSection.vue", feature: "side-nav" },
