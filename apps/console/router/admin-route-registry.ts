...
export const ADMIN_ROUTE_REGISTRY: readonly any[] = Object.freeze([
  ...
  { viewKey: "apiKeyDistribution", slug: "api-key-distribution", componentName: "ApiKeyDistributionView.vue", requiredScopes: ["console:read"], requiredFeatureIds: ["operation-permission-core", "security-permissions"], section: "permission", description: "Guided Agent MCP access and credential management" },
