export const consoleMessages: any = {
  "zh-CN": {
    ...
    journey: {
      ...
      clientKeyDecision: "客户端密钥用于认证下游 MCP 客户端。",
      toolTokenLink: "了解工具令牌",
      clientKeyLink: "了解客户端密钥",
      firstCallCta: "获取客户端密钥与连接配置",
      firstCallRecorded: "已记录首次调用",
      snippetTitle: "连接器配置（按所选客户端目标）",
  ...
  en: {
    ...
    nav: {
      ...
      apiKeyDistribution: "Key Distribution",
    ...
    journey: {
      ...
      clientKeyDecision: "Client keys authenticate a downstream MCP client.",
      toolTokenLink: "About tool tokens",
      clientKeyLink: "About client keys",
      firstCallCta: "Get a client key and connector config",
      firstCallRecorded: "First call recorded",
      snippetTitle: "Connector config (for the selected client target)",
